...
class Particle {
	constructor( ...args ){
		...
		this.size = rdm( 5 , 10 ) ;
		this.duration = this.size * this.speed * 0.1 ;	// 사이즈가 클수록 빠르게
...
class WinterSnow {
	...
	constructor(){
		...
		this.props = {
			...
			wind : canvas.height * windVariance / 2 ,	// 바람으로 인한 영역 설정
			windVariance : windVariance ,
			speed : 1 ,
			particles : [] ,
		}

		console.log( 'wind :', this.props.wind ) ;
